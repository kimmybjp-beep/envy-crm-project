...
import { Gift, Megaphone, ScanLine, Star } from "lucide-react";
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-[24px] bg-white p-5 shadow-luxury ring-1 ring-ruby-900/10">
          <div className="flex gap-3">
            <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-champagne/20 text-ruby-900">
              <Megaphone />
            </span>
            <div>
              <p className="font-black text-charcoal">ข้อความจาก Admin</p>
              <p className="mt-1 text-charcoal/65">
                {adminMessage?.message ?? "ยังไม่มีประกาศใหม่จากทีม ENVY"}
              </p>
            </div>
          </div>
        </div>
